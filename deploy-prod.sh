...
echo "=========================================="
echo "Application is accessible at: http://72.60.188.146:8082"
echo ""
echo "Service status:"
$COMPOSE_CMD -f docker-compose.prod.yml ps
echo ""
echo "Port mapping:"
docker port $CONTAINER_NAME 2>/dev/null || echo "Checking port mapping..."
echo ""
echo "Container logs (last 50 lines):"
docker logs --tail 50 $CONTAINER_NAME
echo ""
echo "📝 Note: Make sure port 8082 is open in your firewall:"
echo "   Ubuntu/Debian: sudo ufw allow 8082/tcp"
