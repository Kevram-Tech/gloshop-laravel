    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-56 bg-gray-800 border-r-2 border-gray-900 flex flex-col">
            ...
            <nav class="flex-1 px-2 py-2 space-y-0.5 overflow-y-auto">
                ...
                <a href="{{ route('admin.statistics.index') }}" class="flex items-center px-3 py-2 text-xs font-medium {{ request()->routeIs('admin.statistics.*') ? 'bg-gray-900 text-white border-l-2 border-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                    <i class="fas fa-chart-line w-4 mr-2"></i>
                    <span>STATISTIQUES</span>
                </a>
                
                <a href="{{ route('admin.settings.index') }}" class="flex items-center px-3 py-2 text-xs font-medium {{ request()->routeIs('admin.settings.*') ? 'bg-gray-900 text-white border-l-2 border-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
