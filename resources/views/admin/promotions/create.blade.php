...
@section('title', 'Nouvelle Promotion - Admin')
    ...
    <form action="{{ route('admin.promotions.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="number" name="discount_value" step="0.01" value="{{ old('discount_value') }}"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                       placeholder="Ex: 10 pour 10% ou 5000 pour 5000 FCFA">
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <p class="text-sm text-gray-500 mt-1">Maintenez Ctrl/Cmd pour sélectionner plusieurs</p>
            </div>
