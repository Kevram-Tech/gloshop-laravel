...
@section('title', 'Nouveau Produit - GloShop Admin')
@section('page-title', 'NOUVEAU PRODUIT')
@section('page-subtitle', 'CRÉATION')

@section('content')
<form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="bg-white border-2 border-gray-300 p-6">
    @csrf
    ...
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label class="block text-xs font-bold text-gray-900 uppercase mb-2">Prix (FCFA) *</label>
            ...
            <div>
                <label class="block text-xs font-bold text-gray-900 uppercase mb-2">Stock *</label>
        ...
        <div>
            <label class="block text-xs font-bold text-gray-900 uppercase mb-2">Catégorie *</label>
        ...
        <div>
            <label class="block text-xs font-bold text-gray-900 uppercase mb-2">Images</label>
        ...
        <div class="flex space-x-4">
            ...
            <a href="{{ route('admin.products.index') }}" class="bg-gray-200 text-gray-800 px-6 py-2 text-xs font-bold uppercase hover:bg-gray-300 border-2 border-gray-300">
                Annuler
            </a>
        </div>
    </div>
